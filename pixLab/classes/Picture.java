  ...
  public void negate()
  {
    ...
    for (Pixel[] rowArray : pixels)
    {
      for (Pixel pixelObj : rowArray)
      {
        ...
        pixelObj.getGreen(255-pixelObj.getGreen());
      }
    }
  }
  ...
  public void fixUnderwater()
  {
    ...
    for (Pixel[] rowArray : pixels)
    {
      for (Pixel pixelObj : rowArray)
      {
        ...
        pixelObj.setRed(pixelObj.getGreen()+pixelObj.getRed());
      }
    }
  }
